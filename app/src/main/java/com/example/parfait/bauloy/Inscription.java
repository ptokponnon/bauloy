 ...
 * {@link Inscription.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Inscription#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Inscription extends Fragment implements ChoiceDialog.ChoiceDialogListener {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    final CaldroidFragment caldroidFragment = new CaldroidSampleCustomFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        extraData.put("prefFile", R.string.preference_file_notation);
        ...
        t.replace(R.id.caldroid_container, caldroidFragment);
        t.commit();
        setHasOptionsMenu(true);
    }

    public void displayChoiceDialog(Date begin, Date end){
        android.support.v4.app.DialogFragment dialogFragment = new ChoiceDialog();
        Bundle args = new Bundle();
        ...
        dialogFragment.show(getFragmentManager(), "Se noter");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.inscription, container, false);
    }
